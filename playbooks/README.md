...
1. Press the "select app" dropdown and select "other". Then enter any name you like such as "Lucid Notifications". This will only be used here but should be recognizable.
